...
The following steps will integrate Cloudflare Zero Trust by using an Account API Token with the below API permissions. Currently setup is limited to using an Account API Token with an api token and domain.
